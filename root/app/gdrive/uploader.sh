...
mkdir -p /config/{pid,json,logs,vars/gdrive,discord}
...
DOWNLOADIGNORE=$(! -path '**torrent/**' ! -path '**nzb/**' ! -path '**nzbget/**' ! -path '**jdownloader2/**' ! -path '**sabnzbd/**' ! -path '**rutorrent/**' ! -path '**deluge/**' ! -path '**qbittorrent/**')
